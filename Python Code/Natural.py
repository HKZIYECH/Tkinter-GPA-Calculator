...
window.title("GPA Calculator Grade 11 and 12 Natural")

title= Label(text="GPA Calculator 11/12 Natural", font=("SF Pro Display", 35), fg="#e62e2e")
title.pack()
...
technicalDrawing = Label(text="T.D")
technicalDrawing.place(relx=0.7, rely=0.2)

td = Entry(window, width=4, borderwidth=2)
td.place(relx=0.8, rely= 0.2)

civics = Label(text="Civics")
civics.place(relx=0.7, rely=0.3)

civ = Entry(window, width=4, borderwidth=2)
civ.place(relx=0.8, rely= 0.3)

ict = Label(text="ICT")
ict.place(relx=0.7, rely=0.4)

it = Entry(window, width=4, borderwidth=2)
it.place(relx=0.8, rely= 0.4)

pe = Label(text="PE")
pe.place(relx=0.7, rely=0.5)

ppe = Entry(window, width=4, borderwidth=2)
ppe.place(relx=0.8, rely= 0.5)
...
def mainExec():
    ...
    mreslt = reseng+ resamh + resmat + resbio + resphy + reschem +  resciv + rstd +resit + respee
...
calcbtn = Button(text="Calculate", font=("SF Pro Display", 15), command=mainExec, bg="#2e5fe6")
